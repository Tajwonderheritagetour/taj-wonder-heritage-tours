  ...
  >
    ...
    <div>
      ...
      >
        ...
        historic cities and timeless traditions. From the Pink City of Jaipur
        to the blue streets of Jodhpur and the romantic lakes of Udaipur,
        Rajasthan offers an unforgettable journey through India's royal
        heritage.
      </p>
      ...
      >
        A private Rajasthan tour allows you to explore the region at your own
        pace with comfortable transportation and local expertise. Whether you
        are interested in history, architecture, culture, food, shopping or
        wildlife, Rajasthan offers experiences for every type of traveler.
      </p>
      ...
      >
        ...
        , creating a memorable journey through India's most iconic heritage
        destinations.
      </p>
    </div>

    {/* Rajasthan Overview Image */}
    ...
    >
      <Image
        src="/images/destinations/rajasthan.jpg"
        alt="Rajasthan royal heritage, forts and palaces"
        fill
      ...
      >
        ...
        >
          ...
          >
            <li>
              <Link href="/destinations/jaipur">Explore Jaipur</Link>
            </li>
            ...
            <li>
              <Link href="/destinations/agra">Explore Agra</Link>
            </li>

            <li>
              <Link href="/destinations/delhi">Explore Delhi</Link>
            </li>
