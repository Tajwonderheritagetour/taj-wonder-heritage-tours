...
`,
  ...
  itinerary: [
...

    {
      ...
      description:
        "After breakfast, begin your private drive from Jaipur to Delhi. Depending on your departure schedule, enjoy free time or additional sightseeing where possible. Complete your Golden Triangle journey with drop-off at Delhi Airport, your hotel or another preferred location.",
    },
  ],
  ...
  knowBefore: [
    ...
    "Some monuments have separate camera or photography restrictions.",
    "Modest clothing is recommended when visiting religious sites.",
    "The itinerary can be customized according to your travel plans.",
  ],
